# RHC Tech SDD v1.3 — Risk Tier Applicability Checklist
...
Use `templates/lightweight-change-record.md`. No runtime behavior change. If a conditional control reveals material impact, reclassify.

## R1

Use `templates/r1-lite-spec.md`. Acceptance criteria and solo adversarial review are mandatory. Apply every conditional control whose surface is affected.
